...
export default function AdminHomePage() {
  ...
  const [, setSevenDayLogs] = useState<any[]>([]);
  ...
  const attentionCount = new Set([...notLoggedToday.map(c => c.id), ...noRoutine.map(c => c.id)]).size;
    ...
    <View style={styles.screen}>
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.actionsRow}>
          ...
          <Pressable style={styles.actionBtn} onPress={() => router.push('/(admin)/manageUsers?tab=progress')}>
...
const styles = StyleSheet.create({
  ...
  statCard: { flex: 1, backgroundColor: COLORS.card, borderRadius: 14, padding: 12, alignItems: 'center', gap: 6, borderWidth: 1, borderColor: COLORS.border },
  ...
  actionLabel: { fontSize: 10, fontWeight: '700', color: COLORS.textPrimary, textAlign: 'center' },

  alertsCard: { backgroundColor: COLORS.card, borderRadius: 14, borderWidth: 1, borderColor: COLORS.border, overflow: 'hidden' },
  alertItem: { flexDirection: 'row', alignItems: 'center', padding: 12, gap: 10 },
  ...
  activityCard: { backgroundColor: COLORS.card, borderRadius: 14, borderWidth: 1, borderColor: COLORS.border, overflow: 'hidden' },
  ...
  emptyCard: { backgroundColor: COLORS.card, borderRadius: 14, borderWidth: 1, borderColor: COLORS.border, padding: 30, alignItems: 'center', gap: 8 },
  emptyText: { fontSize: 13, color: COLORS.textSecondary },

  listCard: { backgroundColor: COLORS.card, borderRadius: 14, borderWidth: 1, borderColor: COLORS.border, overflow: 'hidden' },
  rankItem: { flexDirection: 'row', alignItems: 'center', padding: 12, gap: 10 },
