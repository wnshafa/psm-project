...
export interface UserData {
  ...
  updatedAt?: Timestamp;
  skinType?: string;
  skinConcern?: string | string[]; // Can be a single string or array based on your app logic
  age?: string;
  phoneNumber?: string;
}
...
export interface RoutineLog {
  id: string;
  clientId: string; // Or userId, depending on how you standardized it
  routineID: string;
  type: string;
  status: string;
  mood?: string;
...
export interface Product {
  ...
  category: string;
  description: string;
  skinConcern?: string | string[];   // ✅ FIX
  skinType?: string | string[];      // ✅ FIX
}
export interface ReminderLog {
  id: string;
  clientID: string;
